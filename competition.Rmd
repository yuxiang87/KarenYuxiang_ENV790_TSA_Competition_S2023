...
#Data
##temperature
```{r raw data_Temp eval=FALSE, include=FALSE}
#temperature
...
## load
```{r rawdata_load eval=FALSE, include=FALSE}
#load
...
##humidity
```{r rawdata_humidity eval=FALSE, include=FALSE}
#humidity
...
```{r Neural_Network(2, message=FALSE, warning=FALSE, 2)p=1}
set.seed(6787)
